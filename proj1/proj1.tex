...
\usepackage[top=1.5cm, left=1.6cm, text={18cm, 24.7cm}]{geometry}
...
\begin{quotation}
Čím více \verb|druhů|, \emph{řezů}, {\tiny{velikostí}}, {\color{green}barev} písma a~{\color{blue}\textsc{jiných efektů}} \underline{použijeme}, {\color{red}tím profesionálněji} bude {\fontfamily{pzc}\selectfont{dokument}} vypadat.
