...
\begin{landscape}
    \begin{figure}[ht]
        ...
        \fbox{
            ...
            \multiput(4.3,4.2)(0,0.75){2}{\line(1,0){13.2}}
            \multiput(4.3,4.2)(13.2,0){2}{\line(0,1){0.75}}
            %stairs
            \put(3.5,1.5){\line(0,1){1.5}}
            \put(3.5,3){\line(1,0){3.5}}
            \put(7,3){\line(1,-0.36){4}}
            %floor
            \put(8.4,2.5){\line(1,0){9}}
            \put(17.4,2.5){\line(0,-1){1}}
            %window
            \put(17.2,2.5){\line(0,1){1.5}}
            \put(17.2,4){\line(-1,0){9.8}}
